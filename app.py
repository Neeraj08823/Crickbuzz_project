...
with cols[0]:
    st.page_link("pages/1_Match Timelines.py", label="Match Timelines")
with cols[1]:
    st.page_link("pages/2_Top Player.py", label="Top Players")
with cols[2]:
    st.page_link("pages/3_Queries.py", label="Queries")
