...
with cols[0]:
    st.page_link("pages/1_Live_Matches.py", label="Live Match Page")
with cols[1]:
    st.page_link("pages/2_Top_Player_Stats.py", label="Top Players Page")
with cols[2]:
    st.page_link("pages/3_SQL_Analytics.py", label="SQL Queries Page")
